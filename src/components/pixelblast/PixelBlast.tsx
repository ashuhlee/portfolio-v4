// Adapted from React Bits' PixelBlast component (reactbits.dev), itself
...
interface PixelBlastProps {
	...
	pixelSize?: number;
	color?: string;
	// Overrides `color` while the site is in dark mode. Omit to keep the
	...
	useEffect(() => {
		...
		if (mustReinit) {
			...
			const uniforms = {
				...
				uTime: { value: 0 },
				uColor: { value: new THREE.Color(effectiveColor) },
				uClickPos: {
			...
			t.uniforms.uColor.value.set(effectiveColor);

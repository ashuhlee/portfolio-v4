...
function DitheredWaves({
  ...
  // The original library tracks the pointer via an R3F onPointerMove handler on an
  // invisible mesh, which only fires when the canvas is the topmost element under the
  // cursor. Here the canvas sits behind the page's fixed-position content wrapper, so
  // it never receives pointer events that way. Track the pointer at the window level
